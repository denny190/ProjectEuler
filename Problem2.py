...
#since I skip number 2 on the first iteration so I already write the 'sum' variable equal to 2, and I iterate through the Fibonacci sequence until it approaches 4 million, 
#checking the divisibility by 2 after each increase.
