...
#time to solve could be drastically reduced by having the two for cycles in a function so I can exit the nested loop when it finds the first triplet via returns statement.
